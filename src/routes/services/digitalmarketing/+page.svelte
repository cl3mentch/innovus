<div class="max-w-[1260px] m-auto mb-52">
	...
	<div class="flex justify-between mt-44">
		<div class="w-1/2">
			...
			>
				S O C I A L <span class="ml-2">M E D I A</span>
				<span class="ml-2">M A N A G E M E N T</span>
			</div>
			<p class="text-4xl my-5 font-semibold leading-[1.3em]">
				A major benefit of social media advertising is its ability to reach your exact audience.
			</p>
			<p class="mb-3 max-w-[500px] leading-9">
				Social media platforms allow you to create specific target audiences. Advertisers and social
				media platforms have a sort of symbiotic relationship with one another.
			</p>
		</div>
	...
	<div class="flex justify-between mt-56">
		...
		<div class="flex flex-wrap w-1/2 items-center justify-between">
			...
			<svg
				...
				width="150px"
				height="150px"
				viewBox="0 0 520.48 560"
				id="tiktok"
				><rect width="520.48" height="520.48" rx="49.82" ry="49.82" /><path
					fill="#ff004f"
			...
			>
			<!--WHATSAPP LOGO-->
			<img width="150px" src="/whatsapp.png" alt="" class="mb-3" />
